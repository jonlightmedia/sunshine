...
<?php $category = get_the_category(3); ?>
<?php 
...
?>
<div class="banner banner-md" style="background: url('<?php echo $banner_img; ?>')no-repeat">
	<div class="container">
		<div class="section-tab tab-banner tab">	
			<ul  class="section-tabbed list-reset list-block tabbed-col-3">
				<li><a href="<?php bloginfo('url'); ?>/category/save/" class="active">Save Blogs</a></li>
				<li><a href="<?php bloginfo('url'); ?>/category/invest/">Invest Blogs</a></li>
				<li><a href="<?php bloginfo('url'); ?>/category/protect/">Protect Blogs</a></li>
			</ul>
